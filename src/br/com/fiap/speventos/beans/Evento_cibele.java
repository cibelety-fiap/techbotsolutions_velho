...
public class Evento_cibele {
	...
	public Evento_cibele() {

	}

	public Evento_cibele(int codigoEvento, String linkImagem, String nomeEvento, String tipoEvento, String subtipoEvento,
